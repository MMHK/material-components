...
/***/ function(module, exports, __webpack_require__) {
	...
	var docs_1 = __webpack_require__(7);
	var directives_1 = __webpack_require__(8);
	var mixins_1 = __webpack_require__(15);
	var docs_2 = __webpack_require__(7);
	var vue_1 = __webpack_require__(257);
	var materialize_1 = __webpack_require__(259);
	var doc_api_1 = __webpack_require__(261);
	var doc_sources_1 = __webpack_require__(263);
	var snippet_1 = __webpack_require__(150);
	var doc_tabs_1 = __webpack_require__(265);
	...
	module.exports = {
	    ...
	    registerComponents: function () {
	        for (var componentName in docs_1.default) {
	            Vue.component(componentName, docs_1.default[componentName]);
	        }
	    },
	    registerDirectives: function () {
	        for (var directiveName in directives_1.default) {
	            Vue.directive(directiveName, docs_1.default[directiveName]);
	        }
	    },
	    ...
	    BaseComponent: docs_2.BaseComponent,
	    components: docs_1.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buttons_1 = __webpack_require__(122);
	var cards_1 = __webpack_require__(143);
	var collapsibles_1 = __webpack_require__(160);
	var dropdowns_1 = __webpack_require__(177);
	var forms_1 = __webpack_require__(191);
	var waves_1 = __webpack_require__(251);
	var docsPages = [
	    {
	        urls: ['/'],
	        link: '/',
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *************************/ /*! VelocityJS.org jQuery Shim (1.0.1). (C) 2014 The jQuery Foundation. MIT @license: en.wikipedia.org/wiki/MIT_License. */ /* This file contains the jQuery functions that Velocity relies on, thereby removing Velocity's dependency on a full copy of jQuery, and allowing it to work in any environment. */ /* These shimmed functions are only used if jQuery isn't present. If both this shim and jQuery are loaded, Velocity defaults to jQuery proper. */"use strict";(function(window){"use strict"; /***************
		 Setup
	...
	if(!keys){delete cache[id];}else {$.each(keys,function(_,key){delete store[key];});}}}; /* jQuery */$.extend = function(){var src,copyIsArray,copy,name,options,clone,target=arguments[0] || {},i=1,length=arguments.length,deep=false;if(typeof target === "boolean"){deep = target;target = arguments[i] || {};i++;}if(typeof target !== "object" && $.type(target) !== "function"){target = {};}if(i === length){target = this;i--;}for(;i < length;i++) {if(options = arguments[i]){for(name in options) {if(!options.hasOwnProperty(name)){continue;}src = target[name];copy = options[name];if(target === copy){continue;}if(deep && copy && ($.isPlainObject(copy) || (copyIsArray = $.isArray(copy)))){if(copyIsArray){copyIsArray = false;clone = src && $.isArray(src)?src:[];}else {clone = src && $.isPlainObject(src)?src:{};}target[name] = $.extend(deep,clone,copy);}else if(copy !== undefined){target[name] = copy;}}}}return target;}; /* jQuery 1.4.3 */$.queue = function(elem,type,data){function $makeArray(arr,results){var ret=results || [];if(arr){if(isArraylike(Object(arr))){ /* $.merge */(function(first,second){var len=+second.length,j=0,i=first.length;while(j < len) {first[i++] = second[j++];}if(len !== len){while(second[j] !== undefined) {first[i++] = second[j++];}}first.length = i;return first;})(ret,typeof arr === "string"?[arr]:arr);}else {[].push.call(ret,arr);}}return ret;}if(!elem){return;}type = (type || "fx") + "queue";var q=$.data(elem,type);if(!data){return q || [];}if(!q || $.isArray(data)){q = $.data(elem,type,$makeArray(data));}else {q.push(data);}return q;}; /* jQuery 1.4.3 */$.dequeue = function(elems,type){ /* Custom: Embed element iteration. */$.each(elems.nodeType?[elems]:elems,function(i,elem){type = type || "fx";var queue=$.queue(elem,type),fn=queue.shift();if(fn === "inprogress"){fn = queue.shift();}if(fn){if(type === "fx"){queue.unshift("inprogress");}fn.call(elem,function(){$.dequeue(elem,type);});}});}; /******************
	 ...
	 Velocity.js
	 ******************/(function(factory){"use strict"; /* CommonJS module. */if(typeof module === "object" && typeof module.exports === "object"){module.exports = factory(); /* AMD module. */}else if(true){!(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)); /* Browser globals. */}else {factory();}})(function(){"use strict";return (function(global,window,document,undefined){ /***************
			 Summary
			 ***************/ /*
			 ...
			 *************/var Velocity={ /* Container for page-wide Velocity state data. */State:{ /* Detect mobile devices to determine if mobileHA should be turned on. */isMobile:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), /* The mobileHA option's behavior changes on older Android devices (Gingerbread, versions 2.3.3-2.3.7). */isAndroid:/Android/i.test(navigator.userAgent),isGingerbread:/Android 2\.3\.[3-7]/i.test(navigator.userAgent),isChrome:window.chrome,isFirefox:/Firefox/i.test(navigator.userAgent), /* Create a cached element for re-use when checking for CSS property prefixes. */prefixElement:document.createElement("div"), /* Cache every prefix match to avoid repeating lookups. */prefixMatches:{}, /* Cache the anchor used for animating window scrolling. */scrollAnchor:null, /* Cache the browser-specific property names associated with the scroll anchor. */scrollPropertyLeft:null,scrollPropertyTop:null, /* Keep track of whether our RAF tick is running. */isTicking:false, /* Container for every in-progress call to Velocity. */calls:[]}, /* Velocity's custom CSS stack. Made global for unit testing. */CSS:{ /* Defined below. */}, /* A shim of the jQuery utility functions used by Velocity -- provided by Velocity's optional jQuery shim. */Utilities:$, /* Container for the user's custom animation redirects that are referenced by name in place of the properties map argument. */Redirects:{ /* Manually registered by the user. */},Easings:{ /* Defined below. */}, /* Attempt to use ES6 Promises by default. Users can override this with a third-party promises library. */Promise:window.Promise, /* Velocity option defaults, which can be overriden by the user. */defaults:{queue:"",duration:DURATION_DEFAULT,easing:EASING_DEFAULT,begin:undefined,complete:undefined,progress:undefined,display:undefined,visibility:undefined,loop:false,delay:false,mobileHA:true, /* Advanced: Set to false to prevent property values from being cached between consecutive Velocity-initiated chain calls. */_cacheValues:true}, /* A design goal of Velocity is to cache data wherever possible in order to avoid DOM requerying. Accordingly, each element has a data cache. */init:function init(element){$.data(element,"velocity",{ /* Store whether this is an SVG element, since its properties are retrieved and updated differently than standard HTML elements. */isSVG:Type.isSVG(element), /* Keep track of whether the element is currently being animated by Velocity.
						 ...
						 2) Post-hook-injection root values can be transferred over to consecutively chained Velocity calls as starting root values. */rootPropertyValueCache:{}, /* A cache for transform updates, which must be manually flushed via CSS.flushTransformCache(). */transformCache:{}});}, /* A parallel to jQuery's $.css(), used for getting/setting Velocity's hooked CSS properties. */hook:null, /* Defined below. */ /* Velocity-wide animation time remapping for testing purposes. */mock:false,version:{major:1,minor:3,patch:1}, /* Set to 1 or 2 (most verbose) to output debug info to console. */debug:false}; /* Retrieve the appropriate scroll anchor and property name for the browser: https://developer.mozilla.org/en-US/docs/Web/API/Window.scrollY */if(window.pageYOffset !== undefined){Velocity.State.scrollAnchor = window;Velocity.State.scrollPropertyLeft = "pageXOffset";Velocity.State.scrollPropertyTop = "pageYOffset";}else {Velocity.State.scrollAnchor = document.documentElement || document.body.parentNode || document.body;Velocity.State.scrollPropertyLeft = "scrollLeft";Velocity.State.scrollPropertyTop = "scrollTop";} /* Shorthand alias for jQuery's $.data() utility. */function Data(element){ /* Hardcode a reference to the plugin name. */var response=$.data(element,"velocity"); /* jQuery <=1.4.2 returns null instead of undefined when no match is found. We normalize this behavior. */return response === null?undefined:response;} /**************
			 Easing
					 ...
					 the call array is pushed to Velocity.State.calls for live processing by the requestAnimationFrame tick. */function buildQueue(next){var data,lastTweensContainer; /*******************
						 ...
						 *****************************************/ /* Note: In order to be subjected to chaining and animation options, scroll's tweening is routed through Velocity as if it were a standard CSS property animation. */if(action === "scroll"){ /* The scroll action uniquely takes an optional "offset" option -- specified in pixels -- that offsets the targeted scroll position. */var scrollDirection=/^x$/i.test(opts.axis)?"Left":"Top",scrollOffset=parseFloat(opts.offset) || 0,scrollPositionCurrent,scrollPositionCurrentAlternate,scrollPositionEnd; /* Scroll also uniquely takes an optional "container" option, which indicates the parent element that should be scrolled --
							 ...
							 ***************************/ /* This function parses property data and defaults endValue, easing, and startValue as appropriate. */ /* Property map values can either take the form of 1) a single value representing the end value,
							 ...
							 the element's current value. Read Velocity's docmentation to learn more about forcefeeding: VelocityJS.org/#forcefeeding */var parsePropertyValue=function parsePropertyValue(valueData,skipResolvingEasing){var endValue,easing,startValue; /* Handle the array format, which can be structured as one of three potential overloads:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = (function () {
	    ...
	    Object.defineProperty(Card.prototype, "closeSlot", {
	        get: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectField = (function () {
	    ...
	    SelectField.prototype.refreshContent = function () {
	        this.options = {};
	        var options = this.$getAllChildren().filter(function (c) { return c instanceof option_1.default; });
	    ...
	    Object.defineProperty(SelectField.prototype, "inMobileSingeView", {
	        get: function () {
	    ...
	    Object.defineProperty(SelectField.prototype, "supportTouch", {
	        get: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_class_component_1 = __webpack_require__(6);
	var raised_1 = __webpack_require__(123);
	var floating_1 = __webpack_require__(126);
	var fab_1 = __webpack_require__(128);
	var fab_horizontal_1 = __webpack_require__(130);
	var fab_click_1 = __webpack_require__(132);
	var Butons = (function () {
	    function Butons() {
	    }
	    Butons.prototype.data = function () {
	        return {
	            api: __webpack_require__(134),
	            snippets: {
	                raisedButtons: __webpack_require__(135),
	                floatingButtons: __webpack_require__(136),
	                fabButtons: __webpack_require__(137),
	                fabHorizontalButtons: __webpack_require__(138),
	                fabClickButtons: __webpack_require__(139)
	            },
	            src: {
	                script: __webpack_require__(140),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reveal_1 = __webpack_require__(148);
	var snippet_1 = __webpack_require__(150);
	var Cards = (function () {
	    function Cards() {
	    }
	    Cards.prototype.data = function () {
	        return {
	            api: __webpack_require__(152),
	            snippets: {
	                defaultCard: __webpack_require__(153),
	                imageCard: __webpack_require__(154),
	                revealCard: __webpack_require__(155)
	            },
	            src: {
	                script: __webpack_require__(156),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_class_component_1 = __webpack_require__(6);
	var defaultCollapsible_1 = __webpack_require__(161);
	var popoutCollapsible_1 = __webpack_require__(163);
	var expendableCollapsible_1 = __webpack_require__(165);
	var Collapsibles = (function () {
	    ...
	    Collapsibles.prototype.data = function () {
	        return {
	            ...
	            snippets: {
	                defaultCollapsible: __webpack_require__(169),
	                popoutCollapsible: __webpack_require__(170),
	                expendableCollapsible: __webpack_require__(171)
	            },
	            src: [
	                {
	                    name: 'Collapsible',
	                    script: __webpack_require__(172),
	                    template: __webpack_require__(173)
	                },
	                {
	                    name: 'Collapsible item',
	                    script: __webpack_require__(174),
	                    template: __webpack_require__(175)
	                }
	            ]
	        };
	    };
	    Collapsibles = __decorate([
	        vue_class_component_1.default({
	            components: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExpendableCollapsible = (function () {
	    ...
	    ExpendableCollapsible = __decorate([
	        vue_class_component_1.default({
	            components: components_1.default,
	            directives: directives_1.default,
	...
	var Dropdowns = (function () {
	    ...
	    Dropdowns.prototype.data = function () {
	        return {
	            ...
	            snippets: {
	                defaultDropdown: __webpack_require__(183)
	            },
	            src: [
	                {
	                    name: 'Dropdown',
	                    script: __webpack_require__(184),
	                    template: __webpack_require__(185)
	                },
	                {
	                    name: 'Dropdown list',
	                    script: __webpack_require__(186),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_class_component_1 = __webpack_require__(6);
	var input_fields_1 = __webpack_require__(192);
	var input_icon_fields_1 = __webpack_require__(194);
	var textareas_1 = __webpack_require__(196);
	var selects_1 = __webpack_require__(198);
	var radios_1 = __webpack_require__(200);
	var checkboxes_1 = __webpack_require__(202);
	var switches_1 = __webpack_require__(204);
	var file_inputs_1 = __webpack_require__(206);
	var Forms = (function () {
	    function Forms() {
	    }
	    Forms.prototype.data = function () {
	        return {
	            api: [
	                {
	                    name: 'Input',
	                    api: __webpack_require__(208)
	                },
	                {
	                    name: 'Textarea',
	                    api: __webpack_require__(209)
	                },
	                {
	                    name: 'Select',
	                    api: __webpack_require__(210)
	                },
	                {
	                    name: 'Option',
	                    api: __webpack_require__(211)
	                },
	                {
	                    name: 'Radio group',
	                ...
	                {
	                    name: 'Radio',
	                    api: __webpack_require__(213)
	                },
	                {
	                    name: 'Checkbox group',
	                    api: __webpack_require__(214)
	                },
	                {
	                    name: 'Checkbox',
	                    api: __webpack_require__(215)
	                },
	                {
	                    name: 'Switch',
	                    api: __webpack_require__(216)
	                },
	                {
	                    name: 'File input',
	                    api: __webpack_require__(217)
	                }
	            ],
	            snippets: {
	                inputFields: __webpack_require__(218),
	                inputIconFields: __webpack_require__(219),
	                textareas: __webpack_require__(220),
	                selects: __webpack_require__(221),
	                radios: __webpack_require__(222),
	                checkboxes: __webpack_require__(223),
	                switches: __webpack_require__(224),
	                fileInputs: __webpack_require__(225)
	            },
	            src: [
	                {
	                    name: 'Input field',
	                ...
	                },
	                {
	                    ...
	                    style: __webpack_require__(230)
	                },
	                {
	                    name: 'Select',
	                    script: __webpack_require__(231),
	                    template: __webpack_require__(232),
	                    style: __webpack_require__(233)
	                },
	                {
	                    name: 'Option',
	                ...
	                {
	                    name: 'Radio group',
	                    script: __webpack_require__(236),
	                    template: __webpack_require__(237)
	                },
	                {
	                    name: 'Radio',
	                    script: __webpack_require__(238),
	                    template: __webpack_require__(239),
	                    style: __webpack_require__(240)
	                },
	                {
	                    name: 'Checkbox group',
	                    script: __webpack_require__(241),
	                    template: __webpack_require__(242)
	                },
	                {
	                    name: 'Checkbox',
	                    script: __webpack_require__(243),
	                    template: __webpack_require__(244),
	                    style: __webpack_require__(245)
	                },
	                {
	                    name: 'Switch',
...
/***/ function(module, exports) {
	...
	module.exports = "<span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">div</span> <span class=\"hljs-attribute\">class</span>=<span class=\"hljs-value\">\"input-field\"</span>&gt;</span>\r\n    <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">i</span> <span class=\"hljs-attribute\">v-if</span>=<span class=\"hljs-value\">\"hasSlot('icon-name')\"</span> <span class=\"hljs-attribute\">class</span>=<span class=\"hljs-value\">\"material-icons prefix\"</span>&gt;</span>\r\n        <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">slot</span> <span class=\"hljs-attribute\">name</span>=<span class=\"hljs-value\">\"icon-name\"</span>&gt;</span><span class=\"hljs-tag\">&lt;/<span class=\"hljs-title\">slot</span>&gt;</span>\r\n    <span class=\"hljs-tag\">&lt;/<span class=\"hljs-title\">i</span>&gt;</span>\r\n    <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">input</span> <span class=\"hljs-attribute\">v-if</span>=<span class=\"hljs-value\">\"disabled\"</span> <span class=\"hljs-attribute\">v-model</span>=<span class=\"hljs-value\">\"value\"</span> <span class=\"hljs-attribute\">:name</span>=<span class=\"hljs-value\">\"name\"</span> <span class=\"hljs-attribute\">:placeholder</span>=<span class=\"hljs-value\">\"placeholder\"</span> <span class=\"hljs-attribute\">:id</span>=<span class=\"hljs-value\">\"id\"</span> <span class=\"hljs-attribute\">:type</span>=<span class=\"hljs-value\">\"type\"</span> <span class=\"hljs-attribute\">:lazy</span>=<span class=\"hljs-value\">\"lazy\"</span> <span class=\"hljs-attribute\">v-bind-boolean:number</span>=<span class=\"hljs-value\">\"number\"</span>\r\n        <span class=\"hljs-attribute\">:debounce</span>=<span class=\"hljs-value\">\"debounce\"</span> <span class=\"hljs-attribute\">disabled</span>=<span class=\"hljs-value\">\"disabled\"</span> /&gt;</span>\r\n    <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">input</span> <span class=\"hljs-attribute\">v-else</span> <span class=\"hljs-attribute\">v-model</span>=<span class=\"hljs-value\">\"value\"</span> <span class=\"hljs-attribute\">:name</span>=<span class=\"hljs-value\">\"name\"</span> <span class=\"hljs-attribute\">:placeholder</span>=<span class=\"hljs-value\">\"placeholder\"</span> <span class=\"hljs-attribute\">:id</span>=<span class=\"hljs-value\">\"id\"</span> <span class=\"hljs-attribute\">:type</span>=<span class=\"hljs-value\">\"type\"</span> <span class=\"hljs-attribute\">:lazy</span>=<span class=\"hljs-value\">\"lazy\"</span> <span class=\"hljs-attribute\">:maxlength</span>=<span class=\"hljs-value\">\"maxlength || null\"</span>\r\n        <span class=\"hljs-attribute\">v-bind-boolean:number</span>=<span class=\"hljs-value\">\"number\"</span> <span class=\"hljs-attribute\">:debounce</span>=<span class=\"hljs-value\">\"debounce\"</span> @<span class=\"hljs-attribute\">focus</span>=<span class=\"hljs-value\">\"activateField\"</span> @<span class=\"hljs-attribute\">blur</span>=<span class=\"hljs-value\">\"deactivateField\"</span> <span class=\"hljs-attribute\">class</span>=<span class=\"hljs-value\">\"validate\"</span> <span class=\"hljs-attribute\">:class</span>=<span class=\"hljs-value\">\"validationClass\"</span>\r\n    /&gt;</span>\r\n    <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">label</span> <span class=\"hljs-attribute\">v-if</span>=<span class=\"hljs-value\">\"hasSlot()\"</span> <span class=\"hljs-attribute\">:for</span>=<span class=\"hljs-value\">\"id\"</span> <span class=\"hljs-attribute\">:class</span>=<span class=\"hljs-value\">\"labelClasses\"</span> <span class=\"hljs-attribute\">:data-error</span>=<span class=\"hljs-value\">\"errorMsg\"</span> <span class=\"hljs-attribute\">:data-success</span>=<span class=\"hljs-value\">\"successMsg\"</span>&gt;</span>\r\n        <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">slot</span>&gt;</span><span class=\"hljs-tag\">&lt;/<span class=\"hljs-title\">slot</span>&gt;</span>\r\n    <span class=\"hljs-tag\">&lt;/<span class=\"hljs-title\">label</span>&gt;</span>\r\n<span class=\"hljs-tag\">&lt;/<span class=\"hljs-title\">div</span>&gt;</span>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vue_class_component_1 = __webpack_require__(6);
	var default_1 = __webpack_require__(252);
	var Waves = (function () {
	    function Waves() {
	    }
	    Waves.prototype.data = function () {
	        return {
	            snippets: {
	                defaultWaves: __webpack_require__(254)
	            }
	        };
	    };
	    Waves = __decorate([
